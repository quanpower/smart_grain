...
def upgrade():
    ...
    op.create_table('relay_current_rs485_func',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('function_name', sa.String(length=50), nullable=True),
    sa.Column('function_code', sa.String(length=50), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('owned_barns', sa.Text(), nullable=True),
    ...
    sa.Column('node_name', sa.String(length=8), nullable=True),
    sa.Column('grain_storehouse_id', sa.Integer(), nullable=False),
    sa.Column('lora_gateway_id', sa.Integer(), nullable=False),
    sa.Column('grain_barn_id', sa.Integer(), nullable=False),
    ...
    sa.Column('current_no', sa.SmallInteger(), nullable=True),
    ...
    sa.Column('datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['alarm_type_id'], ['alarm_type.id'], ),
    sa.ForeignKeyConstraint(['lora_node_id'], ['lora_node.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('alarm_status',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('lora_node_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('roles')
    op.drop_table('relay_current_rs485_func')
